...
export default function PostASkill ()  {
  ...
  return (
    ...
    <div className = 'Attributes'>
      <p> Looking For A Skill ?</p>
      <div className="postASkill">
      <Link to="/postaskill" className="bg-[#FFB246]  text-black font-bold  py-1 px-3 hover:border-blue-500  loginBtn">
             Have A Skill ?
             </Link>
             </div>
      </div>
...
skills === undefined ? <div className = " spinner " role="status ">
